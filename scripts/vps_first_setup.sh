...
echo "  2. Copiar docker-compose.yml para /opt/maestro/"
echo "  3. Adicionar DNS A: maestro.dockplusai.io → $(curl -s ifconfig.me)"
echo "  4. Push para main → CI/CD faz o deploy automático"
